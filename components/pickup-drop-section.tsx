...
export function PickupDropSection() {
  const openWhatsApp = (msg: string) => {
    const encoded = encodeURIComponent(msg)
    window.open(`https://wa.me/${PRIMARY_WA}?text=${encoded}`, '_blank')
  }
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          <div>
            ...
            <div className="pickup-cta-row" style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              ...
              <a href={`tel:${PRIMARY_TEL}`} className="pickup-call-btn">
                <Phone size={14} />
                Call Us
              </a>
            </div>
        ...
        {/* ── Bottom CTA Banner — PRIMARY number ── */}
        <div style={{
          background: 'linear-gradient(135deg, #0d2415 0%, #1a3c2e 100%)',
          padding: '40px 48px',
          display: 'flex',
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', position: 'relative', zIndex: 1 }}>
            ...
            {/* PRIMARY call number displayed */}
            <a href={`tel:${PRIMARY_TEL}`} className="pickup-call-btn" style={{ color: '#fff' }}>
              <Phone size={14} />
              +91 97442 01662
            </a>
          </div>
