...
const socials = [
  { href: 'https://www.instagram.com/varkala_mangrove_moments', icon: Instagram, label: 'Instagram' },
  { href: 'https://youtube.com', icon: Youtube, label: 'YouTube' },
  { href: `https://wa.me/${PRIMARY_WA}`, icon: MessageCircle, label: 'WhatsApp' },
]
        ...
        >
          ...
          <div>
            ...
            <div className="ft-contact-item">
              <MapPin size={14} color="rgba(201,168,76,0.5)" strokeWidth={1.5} style={{ marginTop: 2, flexShrink: 0 }} />
              <span className="ft-contact-text">
                Paravur Lake, Varkala<br />Kerala – 691334, India
              </span>
            </div>
            ...
            <div className="ft-contact-item" style={{ marginTop: 4 }}>
              <Phone size={14} color="rgba(201,168,76,0.5)" strokeWidth={1.5} style={{ flexShrink: 0 }} />
              <div>
                <a href={`tel:${PRIMARY_TEL}`} className="ft-contact-text">+91 97442 01662</a>
                <div style={{ fontFamily: "'Jost', sans-serif", fontSize: '0.65rem', color: 'rgba(255,255,255,0.25)', marginTop: 1 }}>
                  Alt: <a href={`tel:${ALT_TEL}`} style={{ color: 'rgba(255,255,255,0.25)', textDecoration: 'none' }}>+91 98950 23973</a>
                </div>
              </div>
            </div>
            ...
            <div className="ft-contact-item" style={{ marginTop: 4 }}>
              <MessageCircle size={14} color="rgba(201,168,76,0.5)" strokeWidth={1.5} style={{ flexShrink: 0 }} />
              <a href={`https://wa.me/${PRIMARY_WA}`} target="_blank" rel="noopener noreferrer" className="ft-contact-text">
                Chat on WhatsApp
              </a>
            </div>
