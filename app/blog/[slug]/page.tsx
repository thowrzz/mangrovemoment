...
const posts = {
  'varkala-mangrove-kayaking-guide': {
    ...
    metaTitle: 'Varkala Mangrove Kayaking Guide | Slot Timings & Prices',
    metaDesc: 'Everything you need to know about guided mangrove kayaking near Varkala. Details on prices, timing, safety vests, and reaching Paravur Backwaters.',
    date: 'June 5, 2026',
    readTime: '6 min read',
    image: '/Kayaking.png',
  ...
  'sunrise-vs-sunset-kayaking': {
    ...
    metaTitle: 'Sunrise vs Sunset Kayaking in Varkala | Which is Best?',
    metaDesc: 'Compare sunrise vs sunset kayaking slots at Paravur Backwaters near Varkala. Which slot offers better bird watching, weather, and photography reflections?',
    date: 'May 28, 2026',
    readTime: '4 min read',
    image: '/two.jpg',
  ...
  'best-backwater-activities-varkala': {
    ...
    metaTitle: 'Things to Do near Varkala | Best Backwater Activities',
    metaDesc: 'Discover the top backwater activities near Varkala: guided mangrove kayaking, traditional country boat cruises, stand up paddleboarding, and water sports.',
    date: 'May 15, 2026',
    readTime: '5 min read',
    image: '/contry.jpg',
  ...
  'family-guide-paravur-boat-rides': {
    ...
    metaTitle: 'Family Guide to Varkala Backwater Boat Rides | Paravur',
    metaDesc: 'Planning a family backwater tour near Varkala? Learn about child safety vests, stable wooden country boats, coracle rides, and booking tips for groups.',
    date: 'May 2, 2026',
    readTime: '6 min read',
  ...
  'first-time-mangrove-kayaking-kerala': {
    ...
    metaTitle: 'First Time Kayaking in Kerala Checklist | Varkala Mangrove',
    metaDesc: 'Worried about balance or swimming skills? Read our beginner checklist on clothing, equipment, guides, and safety for Varkala mangrove kayaking.',
    date: 'April 20, 2026',
    readTime: '4 min read',
